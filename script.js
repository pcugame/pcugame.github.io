document.addEventListener("DOMContentLoaded", function()
{
    ...
    addProject("Tele Connect", "2088046", "황인수", "", "125yFxSlJ4YKgvzolOVADzEn-Sh7vc-CV", "", "");
    addProject("현대공군대결", "2188802", "최민섭", "/images/2188802_poster.png", "1BnMe8oqRYMM0sIPhoJD-D06F9l6K1990", "", "https://github.com/f1709/-/blob/main/README.md");
...
projects.forEach(function(proj)
{
	...
	// githubLink가 있을 때만 <a> 태그로 감싸기
	let linkStart = proj.githubLink
		? `<a href="${proj.githubLink}" target="_blank" style="text-decoration: none; color: inherit;">`
		: "";
	let linkEnd = proj.githubLink ? `</a>` : "";
